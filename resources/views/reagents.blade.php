     ...
     <div class="card-body">
         ...
         <form action="{{ url('reagents') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
             ...
             <div class="form-group">
                 <div class="col-sm-6">
                     <input type="text" name="reagent_name" class="form-control" placeholder="薬品名を入力してください">
                 </div>
             </div>
             ...
             <div class="form-group">
                 <div class="col-sm-6">
                     <input type="text" name="reagent_capcity" class="form-control" placeholder="容量を入力してください">
                 </div>
             </div>
             <div class="card-title" style="padding-top:10px;">
                  バーコード
